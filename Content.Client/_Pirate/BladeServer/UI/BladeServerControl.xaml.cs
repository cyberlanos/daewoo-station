...
public sealed partial class BladeServerControl : Control
{
    ...
    public EntityUid? Entity
    {
        ...
        set
        {
            ...
            if (!slotFilled)
            {
                contentLabel = Loc.GetString("pirate-blade-server-rack-slot-empty");
            }
            ...
            {
                contentLabel = Loc.GetString("pirate-blade-server-rack-slot-entity-unknown");
            }

            SlotLabel.Text = Loc.GetString(
                "pirate-blade-server-rack-slot-status",
                ("index", Index + 1),
