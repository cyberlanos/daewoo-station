...
public sealed partial class MassDriverSecurityWireAction : ComponentWireAction<MassDriverComponent>
{
    ...
    public override StatusLightState? GetLightState(Wire wire, MassDriverComponent component)
    {
        return component.Hacked ? StatusLightState.Off : StatusLightState.On;
    }
