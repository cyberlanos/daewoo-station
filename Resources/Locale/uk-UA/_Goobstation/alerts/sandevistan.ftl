...
sandevistan-effect-desc-damage = ви почнете отримувати фізичні ушкодження.
sandevistan-effect-desc-knockdown = вас повалить на землю.
sandevistan-effect-desc-disable = імплант примусово вимкнеться.
sandevistan-effect-desc-death = ви помрете.