disease-swab-unclean = Цей тампон виглядає брудним.
disease-swab-cant-swab = Ви не можете взяти мазок у {$target}.
...
disease-analyzer-report-infection-rate = Швидкість зараження: {NATURALFIXED($rate, 4)}
disease-analyzer-report-immunity-gain = Швидкість приросту імунітету: {NATURALFIXED($rate, 2)}
disease-analyzer-report-mutation-rate = Швидкість мутації: {NATURALFIXED($rate, 3)}
