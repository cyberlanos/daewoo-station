...
cmd-forcepreset-desc = Примусово встановлює ігровий режим на вказаний пресет в наступному раунді.
cmd-forcepreset-help = Використання: forcepreset <ID пресету>
cmd-forcepreset-success = Примусово встановлено ігровий режим на { $preset } в наступному раунді.
