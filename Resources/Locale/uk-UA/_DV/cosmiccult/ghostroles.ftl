...
rogue-ascended-infection-fail = Вам потрібно послабити цю ціль, щоб спотворити її!
rogue-ascended-infection-alreadyinfected = {CAPITALIZE(THE($target))} вже спотворений!
rogue-ascended-infection-error = Ви не можете зробити це зараз.
rogue-ascended-infection-notification = {CAPITALIZE(THE($user))} простягає свої щупальця до {CAPITALIZE(THE($target))}!
rogue-ascended-infection-briefing = Зловісна енергія просочується у вашу психіку. Вас заразив Астральний Вознесений!
     Ви повинні діяти відповідно до своїх настроїв настільки, наскільки це можливо, незалежно від того, чи є ви антагоністом.
rogue-ascended-shatter-fail = Ви не можете зробити це зараз.
...
rogue-ascended-role-greeting = Ви — Астральний Вознесений — тінь трансцендентної речі, що віддзеркалилася в реальності.
    Все закінчиться, як і все інше. Було б найніжнішою добротою донести цю найчистішу істину якомога більшій кількості людей.
objective-condition-maligninfection-title = Спотворити {$count} розумів.
objective-condition-maligninfection-description = Ваш дотик може спотворювати розуми. Пробудіть найчистішу істину в {$count} індивідуумах на борту станції.