drink-component-on-use-is-empty = {$owner} порожнє!
drink-component-on-examine-is-empty = [color=gray]Порожнє[/color]
...
drink-component-on-examine-is-half-empty = Наполовину порожнє
drink-component-on-examine-is-mostly-empty = Майже порожнє
drink-component-on-examine-exact-volume = Містить {$amount}u.
drink-component-try-use-drink-not-open = Спочатку відкрийте {$owner}!
drink-component-try-use-drink-is-empty = {$entity} порожнє!
drink-component-try-use-drink-cannot-drink = Ви не можете нічого пити!
drink-component-try-use-drink-had-enough = Ви не можете випити ще більше!
drink-component-try-use-drink-cannot-drink-other = Вони не можуть пити!
drink-component-try-use-drink-had-enough-other = Вони не можуть випити ще більше!
