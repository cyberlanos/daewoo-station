book-text-sparot-book =    [head=1]What is the Sparot?[/head]
    ...
    {"[head=3]Sparrows[/head]"}
     ...
     • [bold]Knight of Sparrows:[/bold] The Knight of Sparrows is a daring explorer or an intuitive thinker who solves problems with emotional intelligence. [italic]The Maid of Dragons ventures where she mustn't like a moth to a Tesla. She may be highly emotional, or dangerously repressed.[/italic]
